// Linux stub for Hub (ANT USB stick support).
// ANT USB hardware is disabled on Linux (BTLE used instead). All methods are no-ops.
// This file is only compiled on Linux (see ANT.pri).
