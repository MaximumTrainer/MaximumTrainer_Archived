...
class DataHeartRate::PrivateData
{
public:
    PrivateData():
...
int DataHeartRate::size() const
{
    return d_data->values.size();
}

QPointF DataHeartRate::value( int index ) const
{
    return d_data->values[index];
}

QRectF DataHeartRate::boundingRect() const
{
    return d_data->boundingRect;
}

void DataHeartRate::lock()
{
    d_data->lock.lockForRead();
}

void DataHeartRate::unlock()
{
    d_data->lock.unlock();
}

void DataHeartRate::append( const QPointF &sample )
{
    d_data->mutex.lock();
...
void DataHeartRate::clearStaleValues( double limit )
{
...
////////////////////////////////////////////////////////////////////////////////////
DataHeartRate &DataHeartRate::instance()
{
    static DataHeartRate valueVector;
    return valueVector;
}
