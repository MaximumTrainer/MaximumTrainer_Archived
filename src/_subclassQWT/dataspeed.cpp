...
int DataSpeed::size() const
{
    return d_data->values.size();
}

QPointF DataSpeed::value( int index ) const
{
    return d_data->values[index];
}

QRectF DataSpeed::boundingRect() const
{
...
void DataSpeed::unlock()
{
    d_data->lock.unlock();
}

void DataSpeed::append( const QPointF &sample )
{
    d_data->mutex.lock();
...
void DataSpeed::clearStaleValues( double limit )
{
...
////////////////////////////////////////////////////////////////////////////////////
DataSpeed &DataSpeed::instance()
{
    static DataSpeed valueVector;
    return valueVector;
}
