...
> `VLCQT_INSTALL` must point to the VLC-Qt package root (containing `bin/`, `include/`, `lib/`). The pre-built 1.1.0 win64 MSVC package places import `.lib` files in `lib/` and headers in `include/VLCQtCore/` etc.  
